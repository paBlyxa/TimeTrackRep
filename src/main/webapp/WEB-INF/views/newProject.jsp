	...
	<table class="newRecordTable">
		...
		<tbody>
			<tr>
				...
				<td>Актив</td>
				<td>
					<form:select id="selectManagers" path="projectLeaders" multiple="true">
		...
		<tbody>
			<c:forEach var="project" items="${projectList}" varStatus="status">
				<tr class="clickable-row" data-url="/TimeTrack/projects/project?id=<c:url value="${project.projectId}" />">
					...
					<td>Актив</td>
					<td>
						<c:forEach var="leader" items="${project.managers}" varStatus="stat">
					...
					<td id="colLast">				  
						<form action="${deleteUrl}" method="POST">
						      ...
						      <input type="submit" value="Удалить" onClick="return confirm('Удалить проект?')"/>
